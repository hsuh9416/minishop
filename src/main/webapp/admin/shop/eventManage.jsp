			      		...
			      		<div class="card-body">
							<form id="couponManage" method="post" action="/minishop/admin/shop/makeCoupon.do">								
								<div class="form-row">
									...
									<div class="form-group col-4">
										<input type="text" class="form-control" id="coupon_no" placeholder="쿠폰 발행 번호 입력" readonly/>
									</div>
								...
								<div class="form-row">
									...
									<div class="form-group col-2">	
										...
										<select id="target" name="coupon_target" class="form-control">
									...
									<div class="form-group col-3">	
										...
										<select id="type" name="coupon_type" class="form-control">
											<option value="" selected>선택</option>
									...
									<div class="form-group col-8">
								 	...
								 	<div class="form-group col-4">
								 		<label for="discount_mount">쿠폰 할인액(률)</label>
								  		<input type="number" class="form-control" name="discount_mount"/>
								  	</div>									  								  								
								</div>
						    	<div class="form-row justify-content-center">
