	...
	<form id="writeForm">	
		...
		<div class="form-row" id="email">
			<div class="form-group col-3">
				<input type="text" class="form-control" id="email1" name="email1" placeholder="이메일 " data-toggle="tooltip" data-placement="bottom" title="이메일을 입력하세요."/>
			</div>
			<span>@</span>  
			<div class="form-group col-3">
				<input type="text" class="form-control" name="email2" id="email2" data-toggle="tooltip" data-placement="bottom" title="이메일 인증을 하시기 바랍니다."/>
			</div>
			<div class="form-group col-3">
				<select id="inputEmail" class="form-control">
